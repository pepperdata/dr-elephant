...
public class TestConstants {
  ...
  public static final String BASE_URL = "http://localhost:" + TEST_SERVER_PORT + "/test-realm";
  ...
  public static final String APPLY_EVOLUTIONS_DEFAULT_KEY = "play.evolutions.db.default.autoApply";
