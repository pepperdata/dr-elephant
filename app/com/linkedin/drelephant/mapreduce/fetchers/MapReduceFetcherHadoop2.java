...
public class MapReduceFetcherHadoop2 extends MapReduceFetcher {
  ...
  public MapReduceFetcherHadoop2(ElephantContext context, FetcherConfigurationData fetcherConfData) throws IOException {
    super(context, fetcherConfData);

    final String jhistoryAddr = context.getGeneralConf().get("mapreduce.jobhistory.webapp.address");
